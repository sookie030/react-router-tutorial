...
property[MODULES.EDGE_CANNY] = (node) => {
  return [
...

    {
      High: node
        .getProperties()
        .getIn(["Threshold Ratio", "properties", "High", "value"]),
    },

    {
      Low: node
        .getProperties()
        .getIn(["Threshold Ratio", "properties", "Low", "value"]),
    },
  ];
};
  ...
  return [
    {
      Size: `${node
        ...
        .getProperties()
        .getIn(["Size", "properties", "Height", "value"])}`,
    },
  ...
  return [
    {
      Size: `${node
        ...
        .getProperties()
        .getIn(["Size", "properties", "Size Height", "value"])}`,
    },
  ];
};
