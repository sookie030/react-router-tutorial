...
export const BLUR_BIATERAL = 'Blur Biateral';
export const EDGE_SOBEL = 'Edge Sobel';
export const EDGE_PREWITT = 'Edge Prewitt';
export const EDGE_ROBERTS = 'Edge Roberts';
export const EDGE_CANNY = 'Edge Canny';
export const EDGE_HOUGH = 'Edge Hough';
