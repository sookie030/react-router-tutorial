  ...
  <section>
    ...
    <div className="runlist">
      <div className="custom-select">
        <select>
          <option defaultValue="0">Image training.dpl</option>
          <option defaultValue="1">Image training.dpl</option>
          <option defaultValue="2">Grid detection.dpl</option>
          <option defaultValue="3">UI Template</option>
        </select>
      </div>
      <a href="">
        <span>Run</span>
